...
import { store as courseStore } from '@/routes/dashboard/courses';
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Create Course', href: '/dashboard/courses/create' },
];
...
export default function CreateCourse({ categories, tags }: Props) {
