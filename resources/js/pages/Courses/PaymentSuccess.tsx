        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Card className="border-border bg-card mb-8">
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <span className="text-sm text-muted-foreground">{t('payment_success.submission_details.full_name')}</span>
                    <p className="font-medium text-foreground">{submissionData.full_name}</p>
                  </div>
                  <div>
                    <span className="text-sm text-muted-foreground">{t('payment_success.submission_details.phone')}</span>
                    <p className="font-medium text-foreground">{submissionData.phone}</p>
                  </div>
                  <div className="sm:col-span-2">
                    <span className="text-sm text-muted-foreground">{t('payment_success.submission_details.email')}</span>
          ...
          <Card className="border-border bg-muted/30 mt-8">
            <CardContent className="p-6 text-center">
              <h3 className="font-semibold text-foreground mb-2">{t('payment_success.help.title')}</h3>
              <p className="text-sm text-muted-foreground">
